...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.jdx.dev/benchmarks).** Warm installs are about 3x faster than pnpm and ~1.8x faster than Bun in the current benchmarks. Repeat test commands run up to 42x faster than pnpm and up to 8x faster than Bun.
<!-- BENCH_RATIOS:END -->
