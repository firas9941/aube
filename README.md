...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.jdx.dev/benchmarks).** Warm installs are about 8x faster than pnpm and about 5x faster than Bun in the current benchmarks. Repeat test commands run up to 39x faster than pnpm and up to 7x faster than Bun.
<!-- BENCH_RATIOS:END -->
