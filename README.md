...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.jdx.dev/benchmarks).** Warm installs are about 4x faster than pnpm and about 2x faster than Bun in the current benchmarks. Repeat test commands run up to 31x faster than pnpm and up to 5x faster than Bun.
<!-- BENCH_RATIOS:END -->
